export const API_BASE_URL = normalizeBaseUrl(process.env.API_BASE_URL ?? "https://169-58-83-26.sslip.io");
// export const API_BASE_URL = normalizeBaseUrl(process.env.API_BASE_URL ?? "http://127.0.0.1:8080");
