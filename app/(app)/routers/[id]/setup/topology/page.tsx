            ...
            <div key={iface.name} className="panel p-5">
              <div className="mb-4 flex items-start justify-between gap-3">
                <div className="flex items-start gap-3">
                  <div className={`mt-1 flex h-11 w-11 items-center justify-center rounded-md border ${iface.running ? "border-accent bg-emerald-400/10 text-accent" : "border-line bg-soft text-muted"}`}>
